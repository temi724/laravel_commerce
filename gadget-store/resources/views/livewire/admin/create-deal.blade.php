<div class="max-w-7xl mx-auto px-2 sm:px-4">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Add a new flash deal to your inventory</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            <form wire:submit.prevent="createDeal" class="p-6">
                <div class="space-y-6">
                <!-- Product Name -->
                <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number"
                               ...
                               step="0.01"
                               min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('old_price') border-red-500 @enderror"
                               placeholder="0.00">
                        @error('old_price')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
