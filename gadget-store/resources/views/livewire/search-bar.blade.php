    ...
    <div class="flex bg-white rounded-lg shadow-sm border border-gray-300 overflow-hidden">
        ...
        <div class="relative flex-1">
            <input
                ...
                class="w-full px-4 py-3 border-0 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white"
            >
            @if($query)
        ...
        <button
            wire:click="search"
            class="bg-blue-600 text-white px-6 py-3 hover:bg-blue-700 transition-colors duration-200 flex items-center justify-center"
        >
            ...
            @if($query && $searchResults->count() > 0)
                ...
                @foreach($searchResults as $product)
                    <button
                        ...
                        class="w-full px-4 py-3 text-left hover:bg-gray-50 flex items-center space-x-3 transition-colors"
                    >
