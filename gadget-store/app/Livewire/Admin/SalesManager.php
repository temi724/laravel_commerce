...
//     // ];
//     protected $queryString = [
//     'expandedRows' => ['except' => []], // Keep as array
//     'search' => ['except' => ''],
//     'statusFilter' => ['except' => 'all'],
//     'paymentFilter' => ['except' => 'all'],
//     'orderTypeFilter' => ['except' => 'all'],
...
//         Log::info('SalesManager hydrating - expanded rows: ' . count($this->expandedRows));
...
//     {
//         Log::info('Debug State - expandedRows: ' . count($this->expandedRows));
...
//     {
//         $orderId = (string) $orderId; // Always use string for query string compatibility
...
class SalesManager extends Component
{
    ...
    public function toggleExpanded($orderId)
    {
        ...
        if (in_array($orderId, $this->expandedRows)) {
            $this->expandedRows = array_diff($this->expandedRows, [$orderId]);
        } else {
            $this->expandedRows[] = $orderId;
        }
